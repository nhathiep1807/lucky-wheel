...
function AdminBoard() {
  ...
  const onSubmit = (data: UpdateWheelItemsForm) => {
    ...
    formData.append("file", imgFile || selectedItem?.img || "");
  ...
  return (
    <div>
      ...
      <Dialog
        open={isOpenDialog}
        title="Are you have an account ?"
        setOpen={setIsOpenDialog}
        actionButton={
          <div className="flex items-center gap-2 py-2">
            <Button name="Yes" onClick={onClickAddAccount}></Button>
            <Button
              name="Create New"
      ...
      >
        <div>
          If you want to accumulate points for yourself, please provide us with
          your information!
        </div>
      </Dialog>
      <Dialog
        ...
        actionButton={
          <div className="flex items-center gap-2 pt-4">
            ...
            <Button name="Add" onClick={onClickGetUser}></Button>
          </div>
        }
      >
        <Input
